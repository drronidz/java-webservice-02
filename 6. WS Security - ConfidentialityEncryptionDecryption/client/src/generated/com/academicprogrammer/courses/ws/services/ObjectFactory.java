 ...
 * generated in the com.academicprogrammer.courses.ws.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSum_QNAME = new QName("http://services.ws.courses.academicprogrammer.com/", "calculateSum");
    private final static QName _CalculateSumResponse_QNAME = new QName("http://services.ws.courses.academicprogrammer.com/", "calculateSumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.academicprogrammer.courses.ws.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.ws.courses.academicprogrammer.com/", name = "calculateSum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.ws.courses.academicprogrammer.com/", name = "calculateSumResponse")
